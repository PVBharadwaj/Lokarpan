    ...
    <>
      ...
      <div className="kith-overview-div kith-overview-second-div">
        <p>
          ...
          nearly three decades of students and scholars in the pursuit of truth,
          knowledge, and a better world. At Kith, we advocate for quality
          education as a means to unlock every child's potential, fostering a
          future where socio-economic barriers do not hinder growth.
        </p>
      </div>
      <div className="kith-overview-div kith-overview-third-div">
        ...
        <div className="kith-overview-card">
          ...
          <div className="kith-overview-card-text">
            <h3>Who we are?</h3>
            <p>
              Founded in 2014, Kith and Kin School in Auraiya, Uttar Pradesh,
              aims to elevate education levels, especially in low-income
              communities. We strive towards a vision where every child receives
              exceptional education, creating equity that paves the way for
              India's holistic development. Our ecosystem centres on parent,
        ...
        <div className="kith-overview-card kith-overview-card-reverse">
          <div className="kith-overview-card-text">
            <h3>Our faculty</h3>
            <p>
              These are just a few of the dedicated individuals who form the
              backbone of Kith. Our faculty members bring a wealth of
              experience, expertise, and a shared commitment to our mission.
              Each member of our staff plays a crucial role in driving our
              initiatives forward and making a positive impact in the
              communities we serve.
            </p>
            {/* <span className='our-role-faculty'>Shunyuan  Zhang, The professor, Lokarpan</span> */}
          </div>
      ...
      <div className="new-kith-display">
        <div className="kith-overview-div kith-overview-grid">
          <div className="overview-grid-inner kith-overview-grid-inner1">
            <div>
              <p>
                We prioritise accessibility and excellence in education. Join
                our vibrant learning community today.{" "}
              </p>
              <Link to="/kith/admission" className="kith-link">
                Learn more about our Admissions
              </Link>
            </div>
          </div>
          <div className="overview-grid-inner kith-overview-grid-inner2"></div>
          <div className="overview-grid-inner kith-overview-grid-inner3">
            <div className="kith-explore">
              <div>
                Explore transparent and accessible information about tuition
                fees and scholarships available to support your child's
                education journey at the Kith n Kin School
              </div>
              <div className="exll">
                <Link to="/kith/financials" className="kith-explore-link">
          ...
          <div className="overview-grid-inner kith-overview-grid-inner5">
            <div className="kith-explore">
              <div>
                Access essential information about our school's leadership,
                employment opportunities, frequently asked questions, and
          ...
          <div className="overview-grid-inner kith-overview-grid-inner6">
            <div>{/* text can be added in this div */}</div>
          </div>

          <div className="overview-grid-inner kith-overview-grid-inner7">
            <div>
              <p>
                Immerse yourself in our dynamic campus environment, cultural
                activities and a curriculum tailored to meet the diverse
                learning needs of students, empowering them to achieve academic
                excellence and personal growth.
              </p>
              <div className="no-hover-effect">
                <Link to="/kith/life-at-school" className="kith-link1">
                  Read more about Life at School <FaArrowRightLong />
                </Link>{" "}
              </div>
            </div>
          </div>

          <div className="overview-grid-inner kith-overview-grid-inner8"></div>
        </div>
      </div>
      <div className="new-kith-display-mobile">
        <div className="overview-grid-inner-mobile new-kith-display1">
          <div className="padding-20">
            <p>
              We prioritise accessibility and excellence in education. Join our
              vibrant learning community today.{" "}
            </p>
            <Link to="/kith/admission" className="kith-link">
              Learn more about our Admissions
            </Link>
        ...
        <div className="overview-grid-inner-mobile new-kith-display2">
          <div className="padding-20">
            <p>
              Explore transparent and accessible information about tuition fees
              and scholarships available to support your child's education
              journey at the Kith n Kin School
            </p>
            <Link to="/kith/financials" className="kith-link">
              Learn more about our Financials
            </Link>
          </div>
        </div>
        <div
          ...
          className="overview-grid-inner-mobile new-kith-display3"
        >
          <div className="padding-20">
            <p>
              Explore transparent and accessible information about tuition fees
        ...
        <div className="overview-grid-inner-mobile new-kith-display5">
          <div className="padding-20">
            <p>
              Access essential information about our school's leadership,
              employment opportunities, frequently asked questions, and donation
              options to support our mission.
            </p>
            <Link to="/kith/leadership" className="kith-link">
              Read more{" "}
            </Link>
          </div>
        </div>
        <div
          style={{ height: "fit-content" }}
          className="overview-grid-inner-mobile new-kith-display6"
        >
          <div className="padding-20">
            <p>
              Immerse yourself in our dynamic campus environment, cultural
              activities and a curriculum tailored to meet the diverse learning
              needs of students, empowering them to achieve academic excellence
              and personal growth.
            </p>
            <div className="no-hover-effect">
              <Link
