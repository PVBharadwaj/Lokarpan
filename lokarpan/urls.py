...
urlpatterns = [
    ...
    # path('api/staff/', UserProfileView.as_view(), name='about staff'),
    # path('api/staff/', user_views.UserProfileView.get, name='About Staff'),
    path('api/staff/', views.about_staff, name='About Staff'),
