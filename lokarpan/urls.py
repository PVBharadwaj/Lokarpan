...
from newsletter_subscribe.newsletterviews import subscribe
...
# router.register(r"newsletter_subscribe",subscribe,'NewsletterView')

urlpatterns = [
    path('admin/', admin.site.urls),
    path('api/newsletter_subscribe/', subscribe, name='subscribe'),
